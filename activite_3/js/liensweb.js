...
// !!!! ACTIVITE 3 !!!! 
// les liens sont récupérés sur le serveur à l'aide de la fonction AjaxGet 
...
ajouterLienElt.addEventListener("click", function () {
    ...
    formAjoutElt.addEventListener("submit", function (e) {
        ...
        // Enregistrement du nouveau lien sur le serveur à l'aide d'une requête ajaxPost et l'envoie d'un objet au format JSON 
        ...
        // le formulaire est remplacé par le bouton d'ajout, quoiqu'il arrive, même si la requête ajaxPost n'a pas abouti.
        p.innerHTML = "";
        p.appendChild(ajouterLienElt);
